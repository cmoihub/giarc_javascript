...
function initializeMap() {
  ...
  */
  function createMapMarker(placeData) {
    ...
    // infoWindow : little helper window that opens when you click
    // or hover over a pin on a map. gives extra info on a location
  ...
  /*
  search for results on a location if so, it creates a 
